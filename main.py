...
async def on_ready():
    ...
    #await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="the server"), status=discord.Status.idle)
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.competing, name="Northlink Ferries"), status=discord.Status.idle)
...
@tree.command(name="serverinfo",description="Views server info and updates Human Users Count",guild=discord.Object(id=GUILD))
